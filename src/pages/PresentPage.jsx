  ...
  return (
    <div className="h-screen w-screen bg-gradient-to-br from-azul-claro via-white to-azul-bebe fixed inset-0 overflow-hidden">
      ...
      <motion.button
        ...
        animate={{ opacity: 1 }}
        transition={{ delay: 2 }}
        className="fixed bottom-4 right-4 w-10 h-10 bg-slate-800/20 hover:bg-slate-800/40 backdrop-blur-sm rounded-full flex items-center justify-center text-slate-600 hover:text-slate-800 transition-all shadow-sm hover:shadow-md"
        title="Admin"
      >
